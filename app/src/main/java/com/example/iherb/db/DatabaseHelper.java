...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addStartValues(){
        ...
        //иммунитет
        pillList.add(new Pill("California Gold Nutrition, LactoBif", "Пробиотик Lactobif от California Gold Nutrition содержит 8 активных и клинически изученных штаммов пробиотиков (5 видов лактобактерий и 3 вида бифидобактерий) на основе эксклюзивного комплекса пробиотиков FloraFIT® от Danisco®.", 4));
        pillList.add(new Pill("California Gold Nutrition, Gold C","", 5));
        ...
        pillList.add(new Pill("California Gold Nutrition, LactoBif","Доступны с дозировкой 5, 30 и 100 млрд КОЕ в одной вегетарианской капсуле. На основе эксклюзивного комплекса пробиотиков FloraFIT® от Danisco. 8 активных и клинически изученных штаммов пробиотиков. Подходит для вегетарианцев и веганов",4));
        pillList.add(new Pill("Sports Research, пробиотики с отсроченным высвобождением","60 млрд КОЕ. 12 штаммов лакто- & бифидобактерий. Сертификат Non-GMO Project Verified. Certified Vegan: сертифицированный веганский продукт. Без глютена. Качество продукта подтверждено в независимой лаборатории. Пищевая добавка", 4));
        ...
        //органы дыхания
        pillList.add(new Pill("Natural Factors, здоровье легких, бронхов и носа", "Препарат для здоровья легких, бронхов и носовых пазух представляет собой полностью натуральную формулу, разработанную для питания и поддержки всей дыхательной системы.", 1));
        pillList.add(new Pill("Natural Factors, Здоровье дыхательных путей (Lung, Bronchial &amp; Sinus Health)", "Препарат для здоровья легких, бронхов и носовых пазух представляет собой полностью натуральную формулу, разработанную для питания и поддержки всей дыхательной системы.", 1));
        pillList.add(new Pill("Enzymedica, MucoStop", "MucoStop™ содержит комплекс ферментов, специально подобранных для облегчения дыхания. Высокоэффективный фермент Mucolase™ поддерживает естественную способность организма расщеплять и выводить излишки слизи из носовых пазух и носовых ходов.", 1));
        ...
        //снижение веса
        pillList.add(new Pill("Gummiology, жевательные таблетки с яблочным уксусом, для взрослых, с натуральным яблочным вкусом", "Жевательные таблетки с яблочным уксусом для взрослых от Gummiology  Путем естественной ферментации яблок производится яблочный уксус, затем к нему добавляется корень имбиря.", 2));
        ...
        pillList.add(new Pill("Lake Avenue Nutrition, 5-гидрокситриптофан с витаминами B6 и C", "Способствует улучшению качества сна и поддержанию психического здоровья. Не содержит ГМО, сои и глютена. Производится на предприятии, имеющем регистрацию надлежащей производственной практики (GMP)", 5));
        pillList.add(new Pill("Nature's Plus, Spiru-Tein", "Spiru-Tein — научно разработанный продукт с изолятами соевого протеина, получаемыми только из бобов генетически немодифицированной сои (без ГМО) — так, как создала природа.", 2));
        pillList.add(new Pill("EVLution Nutrition, LeanMode", "Контроль веса. Управление метаболизмом. Поддержку аппетита. Насыщение антиоксидантами. Формирование фигуры. Нормальный уровень энергии", 2));

        //сон
        pillList.add(new Pill("Life Extension, Магний в капсулах","Магний поддерживает здоровье сердечно-сосудистой системы и костей, способствует энергетическому обмену и работе мозга, а также помогает поддерживать нормальную работу нервной системы и здоровое артериальное давление.", 5));
        pillList.add(new Pill("Thorne Research, Magnesium Citramate","Магний необходим для выработки энергии, нормализует сердечный ритм, способствует здоровью легких, регулирует уровень глюкозы в крови. Фактически магний участвует в 600 ферментативных процессах в нашем организме.", 5));
        ...
        pillList.add(new Pill("KAL, глицинат магния","Магний обеспечивает питательную поддержку нормальной и здоровой функции мышц. Вегетарианское средство.", 5));
        pillList.add(new Pill("21st Century, магний","Поддержка здоровья костей и мышц. Минеральная добавка. Не содержит глютена. Гарантированное качество — продукт прошел лабораторные испытания. Магний — это незаменимый минерал, который поддерживает здоровье костей и мышц.", 5));
